...
## Management command to load data to database
...
- curl -X GET "http://127.0.0.1:8001/company/NETBOOK"
- curl -X GET "http://127.0.0.1:8001/people/1"
- curl -X GET "http://127.0.0.1:8001/people/1/2"